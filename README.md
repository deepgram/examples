...
| [030](examples/030-livekit-agents-python/) | LiveKit Agents — Voice Assistant with Deepgram STT | Python | STT | LiveKit Agents |
...
| [130](examples/130-telegram-bot-python/) | Telegram Voice Transcription Bot | Python | STT | Telegram |
| [140](examples/140-audio-to-subtitles-python/) | Audio to Subtitles CLI | Python | STT | Deepgram SDK |
| [140](examples/140-flutter-voice-transcription-dart/) | Flutter Voice Transcription | Dart | STT | Flutter |
<!-- examples-table-end -->
